...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <div id="invalidCodeMessage">
        ...
        <p>Ga naar de inlog pagina van de waaiburg app, vul je email in en klik op wachtwoord vergeten om een nieuwe link te verkrijgen.</p>
    </div>
    <div id="resetForm">
        <p class="login-box-msg">Nieuw wachtwoord instellen</p>
        ...
        <div class="form-group has-feedback">
            ...
            <input type="password" class="form-control" id="herhaalWachtwoord" placeholder="Herhaal wachtwoord">
        ...
        <div class="" style="margin-bottom: 5px;">
            <button type="button" onClick="ResetWachtwoord()" class="btn btn-primary btn-block btn-flat">Bevestig wachtwoord</button>
        </div> 
        </form>
    </div>
...
<script>
  ...
  function ResetWachtwoord(){
    if(validateForm()){
      $.ajax({
        type: "POST",
        url: '/api/authApp/resetWachtwoord.php',
        dataType: 'json',
        data: {
            id: <?php echo $_GET['id']; ?>,
        ...
        success: function (result) {
          if(result['status'] == true){
            window.location.href = 'wachtwoordVernieuwdApp.php';
          } else {
            console.log(result['message'])
