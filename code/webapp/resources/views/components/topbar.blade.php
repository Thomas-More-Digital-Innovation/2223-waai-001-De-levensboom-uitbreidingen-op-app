...
<div class="min-h-[56px] bg-[#3c8dbc] flex justify-end items-center px-5 text-white">
    <button onclick="document.getElementById('dropdown').classList.toggle('hidden');" class="text-white hover:bg-gray-200 block " type="button">{{ $user->firstname . ' ' . $user->surname}}</button>
    <!-- Dropdown menu -->
