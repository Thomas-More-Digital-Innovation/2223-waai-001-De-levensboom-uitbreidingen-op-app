              ...
              <div id='0'>
                <div class="flex flex-row gap-5">    
                  <div>
                    ...
                    <select onchange="getDepartments({{ $departmentLists }}, {{ $mentors }}, 'department0', 'mentors0')" name="department0" id="department0" class="border border-[#d2d6de] px-4 py-2 outline-[#3c8dbc]">
